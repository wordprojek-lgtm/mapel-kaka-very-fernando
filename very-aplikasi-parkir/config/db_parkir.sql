...
(`id_kendaraan`,`plat_nomor`,`jenis_kendaraan`,`warna`,`pemilik`,`id_user`)
VALUES
(3, 'AB 1234 UG', 'motor', 'Hitam', 'Tika', NULL),
(4, 'KU 1234 UG', 'mobil', 'Hitam', 'Bayu', NULL);
...
(`id_log`,`id_user`,`aktivitas`,`waktu_aktivitas`) VALUES
...
(`id_tarif`,`jenis_kendaraan`,`tarif_per_jam`) VALUES
(5,'motor',2000),
(6,'mobil',4000),
(7,'lainnya',5000);
...
(`id_parkir`,`id_kendaraan`,`waktu_masuk`,`waktu_keluar`,
`id_tarif`,`durasi_jam`,`biaya_total`,`status`,`id_user`,`id_area`)
VALUES
(10,3,'2026-04-08 15:23:20',NULL,5,NULL,NULL,'masuk',2,2),
(11,4,'2026-04-08 15:23:53','2026-04-08 15:24:31',6,1,4000,'keluar',2,3);
...
INSERT INTO `tb_user`
(`id_user`,`nama_lengkap`,`username`,`password`,`role`,`status_aktif`)
VALUES
...
ALTER TABLE `tb_kendaraan`
ADD CONSTRAINT `tb_kendaraan_ibfk_1`
FOREIGN KEY (`id_user`) REFERENCES `tb_user` (`id_user`);

ALTER TABLE `tb_log_aktivitas`
ADD CONSTRAINT `tb_log_aktivitas_ibfk_1`
FOREIGN KEY (`id_user`) REFERENCES `tb_user` (`id_user`);

ALTER TABLE `tb_transaksi`
ADD CONSTRAINT `tb_transaksi_ibfk_1`
FOREIGN KEY (`id_kendaraan`) REFERENCES `tb_kendaraan` (`id_kendaraan`),
ADD CONSTRAINT `tb_transaksi_ibfk_2`
FOREIGN KEY (`id_tarif`) REFERENCES `tb_tarif` (`id_tarif`),
ADD CONSTRAINT `tb_transaksi_ibfk_3`
FOREIGN KEY (`id_user`) REFERENCES `tb_user` (`id_user`),
ADD CONSTRAINT `tb_transaksi_ibfk_4`
