...
<div class="d-flex align-items-center px-3 py-3">
    ...
    <?php if($_SESSION['role']=='petugas'){ ?>
        <a href="../dashboard/index.php">
            <i class="bi bi-card-text"></i> Dashboard
        </a>
        ...
        <a href="../transaksi/proses_keluar.php">
            <i class="bi bi-box-arrow-right"></i> Parkir Keluar
        </a>
    <?php } ?>
    
    <?php if($_SESSION['role']=='owner'){ ?>
        <a href="../dashboard/index.php"><i class="bi bi-card-text"></i> Dashboard</a>
        <a href="../laporan/index.php"><i class="bi bi-journal-check"></i> Laporan</a>
    <?php } ?>
</div>